...
<style>
    ...
    .navbar {
        background-color: #3498db; /* Change this to your desired navbar background color */
    }

    .navbar-brand,
    .navbar-nav .nav-link {
        color:burlywood; /* Change this to your desired text color */
    }

    .navbar-toggler-icon {
        background-color: #fff; /* Change this to your desired navbar toggler icon color */
    }
    ...
    .dropdown-menu {
        background-color: #3498db; /* Change this to your desired dropdown menu background color */
    }

    .dropdown-item {
        color: #fff; /* Change this to your desired dropdown item text color */
    }
